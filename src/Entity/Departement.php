 ...
 * Departement
 *
 * @ORM\Table(name="departement", indexes={@ORM\Index(name="departement_code", columns={"departement_code"}), @ORM\Index(name="departement_slug", columns={"departement_slug"}), @ORM\Index(name="departement_nom_soundex", columns={"departement_nom_soundex"})})
 * @ORM\Entity
 */
class Departement
{
